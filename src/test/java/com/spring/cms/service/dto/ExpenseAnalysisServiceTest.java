...
import static com.spring.cms.persistence.domain.ExpenseCategory.SALARIES;
...
public class ExpenseAnalysisServiceTest extends AbstractBaseServiceTest {
    ...
    public void thatExpensesInSameYearAndMonthAreGroupedTogether() throws ParseException {
        ...
        // When
        List<DeadlinesDto> deadlines = expenseAnalysisService.listMonthlyDeadlines();
